'''
Modeled after collect_human_demonstrations.py
'''
import argparse
import datetime
import json
...
def collect_trajectory(env_info, arm, env_configuration, start_point, end_point, render, tmp_directory, gripper):
    ...
    collect_pause_grip_trajectories(env, arm, env_configuration, start_point, end_point, render=render)
...
def collect_pause_grip_trajectories(env, arm, env_configuration, start_point, end_point, render=True):
